...
class CharacterRecognition:
    ...
    def draw_adjacent_characters(self, pdf, char_info_list, img_height):
        ...
        # Initialize variables to store the x-coordinate of the first character
        first_char_x = char_info_list[0][1]

        for char_info in char_info_list:
            print("Drawing text at coordinates:", char_info[0][1])
            char_output_filename, x, y, w, h, predicted_char_index, color = char_info
            ...
            # Draw characters with an offset based on their relative x-coordinate
            x_offset = x - first_char_x
            pdf.drawString(first_char_x + x_offset, inverted_y, f"{predicted_char_index}")
